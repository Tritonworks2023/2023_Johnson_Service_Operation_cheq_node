...
var andoridscreendetailsModel = require('./../../models/document/andoridscreendetailsModel');


router.post('/create', async function(req, res) {
  try{
        await andoridscreendetailsModel.create({
...
router.get('/deletes', function (req, res) {
      andoridscreendetailsModel.remove({}, function (err, user) {
...
router.post('/getlist_id', function (req, res) {
        andoridscreendetailsModel.find({project_id:req.body.project_id}, function (err, StateList) {
...
router.get('/getlist', function (req, res) {
        andoridscreendetailsModel.find({}, function (err, Functiondetails) {
...
router.post('/edit', function (req, res) {
        andoridscreendetailsModel.findByIdAndUpdate(req.body._id, req.body, {new: true}, function (err, UpdatedDetails) {
...
router.post('/delete', function (req, res) {
      andoridscreendetailsModel.findByIdAndRemove(req.body._id, function (err, user) {
          if (err) return res.json({Status:"Failed",Message:"Internal Server Error", Data : {},Code:500});
